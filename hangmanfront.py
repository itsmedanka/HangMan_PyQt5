...
class Ui_HangManSecondWindow(object):
    def setupUi(self, HangManSecondWindow):
        ...
        self.Back = QtWidgets.QToolButton(self.centralwidget, clicked = lambda: Ui_HangMan_MainScreen().setupUi(HangMan_MainScreen))
        self.Back.setGeometry(QtCore.QRect(0,750,50,50))
    ...
    def HangManButtons(self,letter):
        if letter in self.word:
            ...
            if self.answers.isalpha():
                    self.TextHangMan.setText(f'YOU WON! ({self.answers})')
            else:
    ...
    def retranslateUi(self, HangManSecondWindow):
        ...
        self.Back.setText(_translate("HangManSecondWindow","<-"))
...
class Ui_HangManThirdWindow(object):
    ...
    def retranslateUi(self, HangManThirdWindow):
        ...
        self.Back.setText(_translate("HangManThirdWindow", "<-"))
